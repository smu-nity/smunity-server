...
public class AccountController {
    ...
    @Operation(summary = "회원 가입", description = "회원 이름과 요청 데이터를 통해 새로운 회원을 등록합니다.")
    ...
    @PostMapping("/login")
    @Operation(summary = "로그인", description = "사용자의 로그인 요청 데이터를 검증하여 액세스 토큰과 리프레시 토큰을 반환합니다.")
    ...
    @PostMapping("/refresh")
    @Operation(summary = "토큰 갱신", description = "리프레시 토큰을 통해 새로운 액세스 토큰과 리프레시 토큰을 발급합니다.")
